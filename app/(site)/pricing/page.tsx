...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Sınırsız Doppa - AI Dopamin Koçu", included: true },
...
const faqs = [
  {
    ...
    answer: "Doppa - AI Dopamin Koçumuz 7/24 erişilebilir, anlık görev parçalama ve motivasyon desteği sağlar. İnsan koçunuz ise ADHD sertifikalı bir uzman olup haftalık 45 dakikalık 1:1 seanslarla derin strateji çalışması, duygusal destek ve uzun vadeli hedef belirleme sunar. Koçluk planında ikisini birlikte kullanırsınız."
  },
  {
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                {
                  icon: Cpu,
                  title: "7/24 Doppa - AI Dopamin Koçu",
