          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              >
                ...
                <span className="text-primary text-sm font-medium">Dikkat ve Motivasyon İyileştirme Platformu</span>
              </motion.div>
              ...
              <motion.h1
                ...
                className="text-4xl md:text-5xl lg:text-[3.5rem] font-bold text-foreground leading-[1.1] tracking-tight mb-6 font-display"
              >
                Dağınık zihinler için <span className="text-gradient">iyileşme</span> alanı
              </motion.h1>
              ...
              >
                Yalnızca bir planlayıcı değil, zihnini toparlayan bir ekosistem.
                AI koçluk ve uzman desteğiyle <span className="text-foreground/80">potansiyeline ulaş</span>.
              </motion.p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">
              Bu düşünce DEHB&apos;li bireylerin en sık yaşadığı duygulardan biri. 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              },
              {
                ...
                desc: "Günlük canlı çalışma odaları. Başkalarıyla birlikte çalışarak odaklanmayı kolaylaştır.",
                highlight: false
              },
              {
                icon: Users,
